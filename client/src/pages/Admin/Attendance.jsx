...
const Attendance = () => {
    ...
    // Fetch attendance when class/date changes
    useEffect(() => {
    ...
    const fetchAttendance = async () => {
        try {
            ...
            // IMPORTANT FIX: rebuild attendance for UI consistency
            setAttendance(
    ...
    const handleSubmit = async () => {
        try {
            ...
            fetchAttendance(); // refresh saved data
        } catch (error) {
            console.error(error);
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div className="rounded-xl bg-green-50 p-4 border border-green-100">
                                ...
                                <p className="text-2xl font-bold text-green-800">
                                    {savedAttendance.records.filter(r => r.status === "present").length}
                                </p>
                            </div>
                            ...
                            <div className="rounded-xl bg-red-50 p-4 border border-red-100">
                                ...
                                <p className="text-2xl font-bold text-red-800">
                                    {savedAttendance.records.filter(r => r.status === "absent").length}
                                </p>
                            </div>
